...
export default async function TransactionsPage({ searchParams }: { searchParams: Promise<RawSearchParams> }) {
  ...
  return (
    <div>
      <h1 className="font-heading text-2xl font-extrabold text-ink">Transactions</h1>
      <p className="mt-1 text-sm text-muted">The one confirmed-money ledger — every income, expense, commission, payable and adjustment event.</p>
