...
export default async function CommunicationEmailTemplatesPage() {
      ...
      <div className="mt-4">
        ...
        {!provider.isConfigured && (
          <p className="mt-2 rounded-lg bg-amber-500/10 px-3 py-2 text-xs text-amber-700">
            Email (SMTP) provider not configured — templates can be created and previewed, but sending is unavailable until credentials are added in Settings.
          </p>
        )}
      </div>
      <div className="mt-6">
