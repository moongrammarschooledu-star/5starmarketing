...
const navItems: { href: string; label: string; icon: typeof LayoutDashboard; section: AdminSection }[] = [
  ...
  { href: "/admin/communications", label: "Communications", icon: MessageSquare, section: "communications" },
  { href: "/admin/accounting", label: "Accounting", icon: Wallet, section: "accounting" },
  ...
  { href: "/admin/ai", label: "AI Assistant", icon: Bot, section: "ai" },
  ...
  { href: "/admin/content", label: "Public Content", icon: Newspaper, section: "content" },
