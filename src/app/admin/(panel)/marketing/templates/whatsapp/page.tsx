    ...
    <div>
      ...
      <div className="mt-4">
        ...
        <p className="mt-1 text-sm text-muted">
          Separate from the existing WhatsApp bulk-messaging templates (WhatsApp → Templates) — these are used only by automation workflows.
        </p>
        {!provider.isConfigured && (
          <p className="mt-2 rounded-lg bg-amber-500/10 px-3 py-2 text-xs text-amber-700">
            WhatsApp Business API not configured — templates can be created and previewed, but SEND_WHATSAPP automation actions will be logged as Skipped. Manual
            WhatsApp click-to-chat links continue to work everywhere else in the site.
          </p>
        )}
      </div>
      <div className="mt-6">
